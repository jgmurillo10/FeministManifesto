var p6_2 = function(s) {
  ...
  s.draw = function() {
    ...
    if(s.select('#p6_2').style('display') == 'block') {
      ...
      s.textStyle(s.BOLD);
      s.textSize(70);
      s.text('PRIVADO', s.windowWidth/2, s.windowHeight/5 + 70);
      ...
      s.textSize(20);
      s.text('AGREGAR AL CALENDARIO', s.windowWidth/2, s.windowHeight/2 + 148);
